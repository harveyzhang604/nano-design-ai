...
export default function Hero() {
  return (
    <header className="relative w-full min-h-[600px] flex items-center justify-center overflow-hidden bg-neutral-950 text-neutral-50 pt-20 pb-32">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <button className="px-8 py-4 rounded-xl bg-neutral-900 text-neutral-300 font-medium text-lg hover:bg-neutral-800 transition-all border border-neutral-800 hover:border-neutral-700 flex items-center gap-2 group">
            <Layers className="w-5 h-5 text-neutral-300 group-hover:text-neutral-100 transition-colors" />
            View Gallery
          </button>
        </motion.div>
