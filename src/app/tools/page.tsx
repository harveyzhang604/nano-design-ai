...
const tools = [
  ...
  { id: 'sketch-to-image', name: '草图转照片', icon: Grid, color: 'from-slate-500 to-zinc-500', desc: '手绘草图真实化', category: 'P1' },
  { id: 'product-photo', name: '产品摄影', icon: Monitor, color: 'from-emerald-500 to-green-500', desc: '电商产品展示图', category: 'P1' },
  { id: 'face-swap', name: 'AI换脸', icon: User, color: 'from-red-500 to-orange-500', desc: '替换照片人脸', category: 'P1' },
  { id: 'outfit-change', name: 'AI换装', icon: Shirt, color: 'from-violet-500 to-purple-500', desc: '多种服装风格选择', category: 'P1' },
  ...
  { id: 'interior-design', name: '室内设计', icon: Home, color: 'from-amber-500 to-yellow-500', desc: '房间装修效果图', category: 'P1' },
  { id: 'partial-redesign', name: '局部改造', icon: Home, color: 'from-yellow-500 to-amber-500', desc: '只改沙发/墙面/地板', category: 'P1' },
  { id: 'age-transform', name: '年龄变化', icon: Baby, color: 'from-teal-500 to-cyan-500', desc: '预测年轻/老年容貌', category: 'P1' },
  { id: 'baby-prediction', name: '婴儿预测', icon: Baby, color: 'from-rose-400 to-pink-600', desc: '预测宝宝长相', category: 'P1' },
  { id: 'gender-swap', name: '性别转换', icon: User, color: 'from-purple-400 to-fuchsia-500', desc: '男女性别转换', category: 'P1' },
  { id: 'hairstyle', name: '发型设计', icon: Sparkles, color: 'from-amber-400 to-orange-500', desc: '试用不同发型', category: 'P1' },
  { id: 'makeup', name: '妆容试用', icon: Sparkles, color: 'from-pink-400 to-rose-500', desc: '虚拟化妆试用', category: 'P1' },
  { id: 'tattoo', name: '纹身预览', icon: Wand, color: 'from-indigo-400 to-purple-500', desc: 'AI纹身效果预览', category: 'P1' },
  ...
  { id: 'filter', name: 'AI滤镜', icon: Filter, color: 'from-violet-500 to-purple-500', desc: '多种艺术滤镜', category: 'P1' },
  ...
  { id: 'claymation', name: '黏土动画', icon: Paintbrush, color: 'from-amber-500 to-yellow-500', desc: 'Wallace & Gromit 风格', category: 'P2' },
  { id: 'action-figure', name: '可动手办', icon: Monitor, color: 'from-blue-500 to-indigo-500', desc: 'Hot Toys 风格', category: 'P2' },
  { id: 'pixel-art', name: '像素艺术', icon: Grid, color: 'from-emerald-500 to-green-500', desc: '8-bit/16-bit 风格', category: 'P2' },
  { id: 'blythe-doll', name: 'Blythe娃娃', icon: Baby, color: 'from-rose-500 to-pink-500', desc: 'Blythe 娃娃风格', category: 'P2' },
  ...
  { id: 'greeting-card', name: '生日贺卡', icon: Heart, color: 'from-pink-400 to-rose-500', desc: 'AI定制贺卡', category: 'P2' },
  ...
  { id: 'fashion-model', name: '服装模特', icon: Shirt, color: 'from-fuchsia-400 to-pink-600', desc: '虚拟模特展示', category: 'P2' },
